...
fun main() {
    ...
    println("The movie ticket price " +
            "for a person aged $child is \$${ticketPrice(child, isMonday)}.")
    println("The movie ticket price " +
            "for a person aged $adult is \$${ticketPrice(adult, isMonday)}.")
    println("The movie ticket price " +
            "for a person aged $senior is \$${ticketPrice(senior, isMonday)}.")
}
